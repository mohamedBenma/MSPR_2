    ...
    <v-row align="center" justify="center">
      <v-col cols="12" sm="8" md="6" lg="5">
        <v-card class="pa-8" elevation="8" rounded="xl">
          ...
          <!-- Formulaire -->
          <v-form @submit.prevent="renewCredentials" ref="form" v-model="formValid">
            <v-text-field
              v-model="username"
              label="Username"
            ...
            <div v-if="credentialsRenewed" class="mt-6">
              ...
              <v-card outlined class="mb-4 pa-4">
                ...
                <div class="text-center mb-3">
                  <p class="text-body-2 mb-2">Scan this QR code for your new password:</p>
                  <img 
          ...
          <div class="text-center mt-4">
            <span>Remember your credentials?
